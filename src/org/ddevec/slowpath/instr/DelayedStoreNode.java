...
public class DelayedStoreNode extends AbstractInsnNode implements Opcodes {
    IntSupplier idxSupplier;
    Type type;

    public DelayedStoreNode(Type type, IntSupplier idxSupplier) {
    ...
    public AbstractInsnNode clone(Map<LabelNode, LabelNode> labels) {
        return new DelayedStoreNode(type, idxSupplier);
    }

    @Override
    public void accept(MethodVisitor mv) {
        mv.visitVarInsn(type.getOpcode(ISTORE), idxSupplier.getAsInt());
    }
